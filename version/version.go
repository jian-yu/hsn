...
// AppName represents the application name as the 'user agent' on the larger HSN network.
const AppName = "hsn"

// Version contains the application semantic version.
//
// TODO: How do we want to version this being that an initial HSN has
// been developed?
const Version = "0.0.1"

// ProtocolVersion is the supported HSN protocol version (e.g., Homestead, Olympic, etc.)
